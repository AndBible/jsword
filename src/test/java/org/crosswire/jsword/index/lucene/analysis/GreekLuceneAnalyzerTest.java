...
public class GreekLuceneAnalyzerTest {
    ...
    public void setUp() throws Exception {
        myAnalyzer = AnalyzerFactory.getInstance().createAnalyzer(new Language("grc"));
    ...
    public void testTokenization() throws ParseException {
        ...
        // Lowercased test
        Assert.assertTrue(query.toString().contains(FIELD + ":\u03B4\u03B9\u03BF\u03C4 "));
        Assert.assertTrue(query.toString().contains(FIELD + ":\u03B1\u03C5\u03C4"));
