...
/**
 * LXXLCV a compromise versification system, intended to allow encoding of Bibles using
 * a number of slightly varying LXX-based versification systems, including Books,
 * appearing in LCV Bible translations (by Viktor Zhuromskyy). In particular, it was
 ...
 * @author DM Smith
 */
public class SystemLXXLCV extends Versification {
    /**
     * Build the "LXXLCV" Versification.
     */
    /* protected */ SystemLXXLCV() {
        super(V11N_NAME, BOOKS_OT, BOOKS_NT, LAST_VERSE_OT, LAST_VERSE_NT);
    }

    public static final String V11N_NAME = "LXXLCV";
